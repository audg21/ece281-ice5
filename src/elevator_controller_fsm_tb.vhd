...
begin
	...
	begin
		...
		--  go up again (edited here)
		w_stop <= '0';  wait for k_clk_period;
		    assert w_floor = x"4" report "bad up from floor3 to floor4" severity failure; 
		-- go back down one floor
		w_stop <= '0'; 
		w_up_down <= '0';
		wait for k_clk_period;
		    assert w_floor = x"3" report "bad down from floor4 to floor3" severity failure;
